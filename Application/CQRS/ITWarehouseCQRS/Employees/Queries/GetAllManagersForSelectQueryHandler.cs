...
internal class GetAllManagersForSelectQueryHandler : IRequestHandler<GetAllManagersForSelectQuery, IQueryable<ManagerVm>>
{
    ...
    public GetAllManagersForSelectQueryHandler(IAppDbContext appDbContext, IMapper mapper)
    {
    ...
    public async Task<IQueryable<ManagerVm>> Handle(GetAllManagersForSelectQuery request, CancellationToken cancellationToken)
    {
        ...
        var res = _mapper.Map<List<ManagerVm>>(itemList);
