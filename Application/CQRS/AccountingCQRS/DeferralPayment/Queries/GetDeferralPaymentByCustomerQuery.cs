...
public class GetDeferralPaymentByCustomerQuery(string i) : IRequest<IQueryable<DeferralPaymentFormVm>>
{
    public string Id { get; set; } = i;
}
public class GetDeferralPaymentByCustomerQueryHandler(IAppDbContext appDbContext, IMapper mapper) : IRequestHandler<GetDeferralPaymentByCustomerQuery, IQueryable<DeferralPaymentFormVm>>
{
