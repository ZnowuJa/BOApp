...
public class GetDeferralPaymentByEmpIdQueryQueryHandler(IAppDbContext appDbContext, IMapper mapper) : IRequestHandler<GetDeferralPaymentByEmpIdQuery, IQueryable<DeferralPaymentFormVm>>
{
