...
public class GetAllTestFormsQueryHandler : IRequestHandler<GetAllTestFormsQuery, IQueryable<TestFormVm>>
{
    private readonly IAppDbContext _appDbContext;
    private readonly IMapper _mapper;
    private readonly ILogger _logger;

    public GetAllTestFormsQueryHandler(IAppDbContext appDbContext, IMapper mapper, ILogger<GetAllTestFormsQueryHandler> logger)
    {
