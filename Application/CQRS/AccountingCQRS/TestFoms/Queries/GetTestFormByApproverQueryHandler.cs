...
public class GetTestFormByApproverQueryHandler : IRequestHandler<GetTestFormByApproverQuery, IQueryable<TestFormVm>>
{
    private readonly IAppDbContext _appDbContext;
    private readonly IMapper _mapper;
    public GetTestFormByApproverQueryHandler(IAppDbContext appDbContext, IMapper mapper)
    {
