...
public class AssignCoCGroupByPositionAdHocJob
{
    private readonly IMediator _mediator;
    private readonly IEmailService _mailService;
    private readonly IConfiguration _configuration;

    public AssignCoCGroupByPositionAdHocJob(IMediator mediator, IEmailService mailService, IConfiguration configuration)
    {
        _mediator = mediator;
    ...
    public async Task<bool> Execute()
    {
        try
        {
            ...
            //After assigning or changing Group assigned to Position
            ...
            foreach (var emp in employees)
            {
                ...
                if (pos != null || pos.GroupCoCId.HasValue)
                {
                    ...
                    {
                        var group = groups.Where(g => g.Id == pos.GroupCoCId).First();
            ...
            var notAssignedEmployees = employees.Where(e => e.CoCGroupId < 1 || e.CoCGroupId != null).ToList();
