        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmpFrom = table.Column<DateOnly>(type: "date", nullable: true),
                    EmpTo = table.Column<DateOnly>(type: "date", nullable: true),
                    ...
                    CompanySAP = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VcdempId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VcdempNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VcddeptNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SapnumberHr = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityUserName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Assets_Notes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Assets_Notes_Assets_itemId",
                        column: x => x.itemId,
                        principalTable: "Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Assets_Notes_Notes_noteId",
                        column: x => x.noteId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isCurrentlyOrderable = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Modified = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalNet = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    CurrencyId = table.Column<int>(type: "int", nullable: false),
                    ItemsGenerated = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Modified = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitNetPrice = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    InvoiceId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assets_Notes_itemId",
                table: "Assets_Notes",
                column: "itemId");

            migrationBuilder.CreateIndex(
                name: "IX_Assets_Notes_noteId",
                table: "Assets_Notes",
                column: "noteId");
