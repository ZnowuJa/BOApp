...
namespace Persistance.Migrations
{
    ...
    [Migration("20240919211334_CoC base entities Position")]
    partial class CoCbaseentitiesPosition
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.CoC.GroupCoC", b =>
                {
                    ...
                    b.Property<int?>("InstructionCoCId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("InstructionCoCId");
            ...
            modelBuilder.Entity("Domain.Entities.CoC.GroupCoC", b =>
                {
                    b.HasOne("Domain.Entities.CoC.InstructionCoC", null)
                        .WithMany("Groups")
                        .HasForeignKey("InstructionCoCId");
                });
